...
class MakeImage extends React.Component {
    ...
    createImage(changedSite) {
        ...
        $.getJSON('/makers/makeImages', function(result) {
            ...
            console.log('MakeImage createImage.done Make Markdown loaded second success');
        })
        .fail(function(jqxhr, textStatus, error) {
            console.log('MakeImage createImage.Make Markdown load error: ' + jqxhr.status + ' ' + textStatus + ' ' + error);
        })
        .always(function() {
            console.log('MakeImage createImage.Make Markdown loaded complete');
        });
    ...
    deleteImage(changedDest) {
        ...
        $.getJSON('/makers/deleteMarkdown', function(result) {
            ...
            console.log('MakeImage deleteImage Delete Markdown loaded second success');
        })
        .fail(function(jqxhr, textStatus, error) {
            var message = 'MakeImage deleteImage Delete Markdown load error: ' + jqxhr.status + ' ' + textStatus + ' ' + error;
            console.log(message);
            that.setState({
        ...
        .always(function() {
            console.log('MakeImage deleteImage Delete Markdown loaded complete');
        });
    }
